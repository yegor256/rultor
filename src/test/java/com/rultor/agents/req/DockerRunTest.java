...
final class DockerRunTest {
     ...
     */
    @Test
    void savesMultipleEnvItems() throws Exception {
     ...
     */
    @Test
    void savesSingleEnvItem() throws Exception {
        MatcherAssert.assertThat(
     ...
     */
    @Test
    void savesEnvItemFromParameter() throws Exception {
        MatcherAssert.assertThat(
            ...
            new DockerRun(
                ...
                "/p/entry[@key='c']"
            ).envs(new ArrayMap<String, String>().with("X", "a\"'b")),
     ...
     */
    @Test
    void readsScriptFromProfile() throws Exception {
        MatcherAssert.assertThat(
     ...
     */
    @Test
    void readsScriptFromSeveralItems() throws Exception {
        MatcherAssert.assertThat(
            ...
            new Brackets(
                new DockerRun(
                    new Profile.Fixed(
                        new XMLDocument(
                            String.format(
                                "<p><entry key='script'>How are you,%ndude</entry></p>"
                            )
                        )
                    ),
                    "/p"
